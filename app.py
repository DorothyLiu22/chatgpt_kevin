...
with st.sidebar:
    ...
    with st.container(border=True,):
        ...
        if st.button("保存聊天", type="primary"):
           chat_history()
           progress_text = "您的聊天记录已保存，请回到问卷页面"
...
#openai_api_key = "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"
...
Do not propose more than 3 points at a time, and do not exceed 100 words. Please don't come up with new ideas if I don’t ask you.

I'm your teammate. Please speak as equals. Don't make a list of bullet points. Answer in one paragraph.

Please communicate with me in Chinese. Do not ask me any question. Your name is "凯文"."""
